    ...
    return(
        <div className="h-[60rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
            <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
                ...
                <div className=" p-4 max-w-7xl text-center mx-auto relative z-10 text-center justify-center w-full pt-20 md:pt-0">
                <Image
                                        unoptimized
                                        alt="music image"
                                        ...
                                        height="300"
                                        width="300"
                                        className="object-contain mx-auto mt-20 mb-10"
                                    />
